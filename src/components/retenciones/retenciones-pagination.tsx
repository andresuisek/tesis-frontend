...
interface RetencionesPaginationProps {
  paginaActual: number;
  totalItems: number;
...
export function RetencionesPagination({
  paginaActual,
  totalItems,
  itemsPorPagina,
  onPaginaChange,
}: RetencionesPaginationProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4">
      <div className="text-sm text-muted-foreground">
        ...
        <span className="font-medium">{totalItems}</span> retenciones
      </div>
